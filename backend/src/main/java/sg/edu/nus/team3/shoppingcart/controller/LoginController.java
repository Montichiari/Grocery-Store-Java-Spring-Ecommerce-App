...
public class LoginController {
	...
	// public ResponseEntity<Map<String, Object>> checkLoginStatus(HttpSession
	// session) {
	// Object id = session.
	// }
	 ...
	 * 
	 * @PostMapping("/login")
	 * public String handleLogin(@RequestParam("email") String
	 ...
	 * userService.findUserByEmail(email).get().getRole());
	 * 
	 * return "redirect:/";
	 * }
	 * 
