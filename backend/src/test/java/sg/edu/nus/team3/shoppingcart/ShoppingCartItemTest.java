...
public class ShoppingCartItemTest {
    ...
    // shoppingCartService.getShoppingCartItemById(cartItemId);
    // assertEquals(newQuantity, updatedItem.getQuantity(), "The quantity of the
    // shopping cart item should be updated.");
    // }
