...
public class OrderServiceTest {
	...
	public Order createOrder(List<OrderItem> orderItems) {
		...
		for (OrderItem orderItem: orderItems) {
			...
			assert product != null && !product.isEmpty() : "Product should be in the list";
			
			assert product.getStock() > 0 : "Stock must be greater than zero. Actual: " + product.getStock();
			assert product.getStock() >= orderItems.getQuantity() : "Product stock must be greater than or equal to order quantity. Actual difference: " 
